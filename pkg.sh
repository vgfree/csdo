...
#echo "eval QA_RPATHS=$[ 0x0002|0x0010 ] rpmbuild --define \"$home\" --define \"_version ${TGT_VERSION}\" --define \"_release ${PACKAGE_RELEASE}\" --define \"_reversion ${PACKAGE_REVERSION}\" -vv -ba $DIR/SPECS/${TGT}.spec"
